...
contract FreeportMarketingLock{
	address manager;
	uint256 public TimeLock = 1642694400; //First unlock at Fri Jan 21 2022 00:00:00 UTC+0800.
    ...
    function withdrawTokens(address tokenAddr) external onlyManager{
        ...
        require(IERC20(tokenAddr).transfer(msg.sender, 10000000 * 10 ** uint(18)));
		TimeLock += 15552000;
    }
